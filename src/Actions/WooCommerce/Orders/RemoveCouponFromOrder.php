...
class RemoveCouponFromOrder extends Action
{
    public function getName()
    {
        return __('Remove applied coupon', 'mantiq');
    }

    public function getDescription()
    {
        return __('Remove an applied coupon on an order.', 'mantiq');
    }
    ...
    {
        return WooCommerceIntegrationWithMantiq::getPath('views/actions/orders/remove-coupon-from-order.php');
    }
